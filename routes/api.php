...
Route::group(['middleware' => 'auth:api'], function(){
  ...
  Route::get('list-of-users', 'API\AdminController@listOfClients');
  ...
  Route::get('client-panic-coordinates', 'API\AdminController@allClientDangerOccurencesCoordinates');
  Route::get('euser/{client_id}/panic-details', 'API\AdminController@clientDangerOccurencesDetails');
